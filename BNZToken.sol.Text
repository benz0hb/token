...
//
// Symbol        : {{BNZ}} // สัญลักษณ์ หรือใส่ชื่อเหรียญที่เราต้องการ
// Name          : {{BNZ Token}} // ชื่อเหรียญ
// Total supply  : {{1000000}} // ราคาเหรียญ
// Decimals      : {{6}} // ทศนิยม
// Owner Account : {{0x40b8cEB872d1C4A3c481565F5b84F2E94D81493B}} // บัญชีเจ้าของ ให้คัดลอกที่ METAMASK ตรง Account
//
...
*/
contract BNZZToken is ERC20Interface, SafeMath {// สัญญา
    ...
    constructor() public {// ตัวสร้าง () สาธารณะ
        symbol = "BNZZ"; // ชื่อเหรียญ
        name = "BNZZ Token"; // ชื่อ โทเค็น ของเรา
        decimals = 6;
        _totalSupply = 10000000;// ราคาเหรียญ
        balances[0x838877386878a1C4Ac9664D7473fe0F49c61BEBa] = _totalSupply;// บัญชีเจ้าของ ให้คัดลอกที่ METAMASK ตรง Account
        emit Transfer(address(0), 0x838877386878a1C4Ac9664D7473fe0F49c61BEBa, _totalSupply);// โอนที่อยู่ โดยให้คัดลอกที่ METAMASK ตรง Account
    }
